...
- Jenkins Proje sayfasında `` tarihi '' altında inşa edilmiş yeni olanı gözlemleyin.

- Yapılan oluşturma sayfasının ayrıntılarını açıklayın.

- Proje sayfasına geri dönün ve GitHub kanca günlüğünü açıklayın.
